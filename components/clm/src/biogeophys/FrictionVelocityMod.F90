...
#include "shr_assert.h"
  ...
  !public :: FV_test                !testing openACC only called in CanopyFluxesMod
  !
...
!!!!========================================================================!!!!
      ...
      if(.not. lnd_index) then
        ...
        do f = 1, fn
          ...
          print *, 'n:',n, 'vds: ', frictionvel_vars%vds_patch(n)
          ...
          !print *, 'n:',n, 'va: ', frictionvel_vars%va_patch(n)
          ...
          !print *, 'n:',n, 'fv: ',frictionvel_vars%fv_patch(n)
